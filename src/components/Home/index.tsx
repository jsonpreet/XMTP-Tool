...
const Login = dynamic(() => import('../Common/Login'), { ssr: false })
    ...
    return (
        <>
            ...
            <div className="flex flex-col px-8 py-20">
                <div className="flex flex-col md:flex-row space-x-0 space-y-5 md:space-y-0 md:space-x-5 items-start justify-start w-full flex-1  text-center">
                    {data && data.length > 0 ? (
                    ...
                    {sendingMessage && sendingMessage.length > 0 && (
                        <div className="flex flex-col space-y-5 items-center justify-center w-full flex-1 text-center">
                            ...
                            <div className="flex flex-col space-y-5 items-center justify-center w-full flex-1 md:px-0 px-8 text-center">
                                {sendingMessage.map((elem: any, index: number) => (
                                    <div key={index} className="flex space-x-5 items-center justify-center w-full flex-1 px-0 text-center">
